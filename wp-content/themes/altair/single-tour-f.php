				...
				<div class="tour_meta_wrapper">
					<div class="page_content_wrapper">
					    ...
					    <div class="<?php echo esc_attr($tour_block_class); ?> last">
					    	<a id="tour_book_btn" <?php if(!empty($tour_booking_url)) { ?>href="<?php echo $tour_booking_url; ?>"<?php }?> class="button center"><?php echo _e( 'Book Now', THEMEDOMAIN ); ?></a>
					    </div>
					</div>
				</div>
			<?php
	...
	<div class="tour_book_content">
		...
		<div class="tour_book_form">
			<div class="tour_book_form_wrapper">
				<h2 class="ppb_title"><?php _e( "Booking for ", THEMEDOMAIN ); ?><?php echo get_the_title(); ?></h2>
