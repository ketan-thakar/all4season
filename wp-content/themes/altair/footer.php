		...
		<div class="social_wrapper">
		    <ul>
		    	...
		    	<?php
		    		...
		    		{
		    	?>
		    	<li class="twitter"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> href="//twitter.com/<?php echo $pp_twitter_username; ?>"><i class="fa fa-twitter"></i></a></li>
		    	<?php
		    		}
		    	?>
		    	<?php
		    		...
		    		{
		    	?>
		    	<li class="flickr"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Flickr" href="//flickr.com/people/<?php echo $pp_flickr_username; ?>"><i class="fa fa-flickr"></i></a></li>
		    	<?php
		    		}
		    	?>
		    	<?php
		    		...
		    		{
		    	?>
		    	<li class="youtube"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Youtube" href="//youtube.com/channel/<?php echo $pp_youtube_username; ?>"><i class="fa fa-youtube"></i></a></li>
		    	<?php
		    		}
		    	?>
		    	<?php
		    		...
		    		{
		    	?>
		    	<li class="vimeo"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Vimeo" href="//vimeo.com/<?php echo $pp_vimeo_username; ?>"><i class="fa fa-vimeo-square"></i></a></li>
		    	<?php
		    		}
		    	?>
		    	<?php
		    		...
		    		{
		    	?>
		    	<li class="tumblr"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Tumblr" href="//<?php echo $pp_tumblr_username; ?>.tumblr.com"><i class="fa fa-tumblr"></i></a></li>
		    	<?php
		    		}
		    	?>
		    	<?php
		    	...
		    	<?php
		    		...
		    		{
		    	?>
		    	<li class="dribbble"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Dribbble" href="//dribbble.com/<?php echo $pp_dribbble_username; ?>"><i class="fa fa-dribbble"></i></a></li>
		    	<?php
		    		}
		    	?>
		    	<?php
		    	...
		    	<?php
		            ...
		            {
		        ?>
		        <li class="pinterest"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Pinterest" href="//pinterest.com/<?php echo $pp_pinterest_username; ?>"><i class="fa fa-pinterest"></i></a></li>
		        <?php
		            }
		        ?>
		        <?php
		        	...
		        	{
		        ?>
		        <li class="instagram"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Instagram" href="//instagram.com/<?php echo $pp_instagram_username; ?>"><i class="fa fa-instagram"></i></a></li>
		        <?php
		        	}
		        ?>
		        <?php
