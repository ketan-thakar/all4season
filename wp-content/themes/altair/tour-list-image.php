...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="three_cols gallery fullwidth section content clearfix list">
	<?php
		$key = 0;
		if (have_posts()) : while (have_posts()) : the_post();
			...
			if(!empty($tour_price_discount) && !empty($tour_price))
			{
	...
	<div class="element portfolio3filter_wrapper">
		...
		<div class="one_third gallery3 filterable gallery_type animated<?php echo $key+1; ?>" data-id="post-<?php echo $key+1; ?>">
			...
			<a href="<?php echo $tour_permalink_url; ?>">
				<div class="tour_list_image" style="background-image:url('<?php echo $image_url[0]; ?>');">	
	            ...
	            <div class="thumb_content fullwidth">
	                ...
	                <div class="thumb_meta fullwidth">
	                	...
	                	{
	                	?>
	                	<div class="tour_price list_image">
