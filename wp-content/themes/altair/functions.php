...
function pp_enqueue_front_page_scripts() {
	...
	foreach($gg_fonts_family as $key => $gg_fonts_family_value)
	{
		...
		{
			wp_enqueue_style('google_font'.$key, "//fonts.googleapis.com/css?family=".$gg_fonts_family_value.":200,300,400,500,600,700,400italic&subset=latin,cyrillic-ext,greek-ext,cyrillic", false, "", "all");
		}
	}
...
#pp_sample_text
{
	...
	<div class="header_wrap">
		...
		<a href="http://themes.themegoods.com/altair/doc" target="_blank"><?php _e( 'Online Documentation', THEMEDOMAIN ); ?></a>&nbsp;|&nbsp;<a href="https://themegoods.ticksy.com/" target="_blank"><?php _e( 'Theme Support', THEMEDOMAIN ); ?></a>
		</div>
